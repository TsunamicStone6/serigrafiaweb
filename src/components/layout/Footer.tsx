...
export function Footer() {
  ...
  const socials = [
    ...
    { icon: <IconTwitter   />, href: siteConfig.social.twitter,   label: 'Twitter'   },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr] gap-8 md:gap-12 mb-10 md:mb-12">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5">
              <li>
                <a href={`tel:${siteConfig.business.phone}`} className="text-[12px] text-brand-gray hover:text-brand-red transition-colors">
                  {siteConfig.business.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${siteConfig.business.email}`} className="text-[12px] text-brand-gray hover:text-brand-red transition-colors">
                  {siteConfig.business.email}
                </a>
              </li>
              <li className="text-[12px] text-brand-gray">{siteConfig.business.address}</li>
            </ul>
          </div>
